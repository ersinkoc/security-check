...
1. **sc-recon** (`.agents/skills/sc-recon.md`)
...
2. **sc-dependency-audit** (`.agents/skills/sc-dependency-audit.md`)
...
| Language | Skill | File |
|----------|-------|------|
| JavaScript/TypeScript | sc-lang-js | `.agents/skills/sc-lang-js.md` |
| Python | sc-lang-python | `.agents/skills/sc-lang-python.md` |
| Go | sc-lang-go | `.agents/skills/sc-lang-go.md` |
| Rust | sc-lang-rust | `.agents/skills/sc-lang-rust.md` |
| Java/Kotlin | sc-lang-java | `.agents/skills/sc-lang-java.md` |
| C/C++ | sc-lang-c | `.agents/skills/sc-lang-c.md` |
| PHP | sc-lang-php | `.agents/skills/sc-lang-php.md` |
| Ruby | sc-lang-ruby | `.agents/skills/sc-lang-ruby.md` |
| C#/.NET | sc-lang-csharp | `.agents/skills/sc-lang-csharp.md` |
| Swift | sc-lang-swift | `.agents/skills/sc-lang-swift.md` |

#### Category Skills (always run relevant ones):

| Category | Skill | File |
|----------|-------|------|
| Web Security | sc-web | `.agents/skills/sc-web.md` |
| API Security | sc-api | `.agents/skills/sc-api.md` |
| Authentication | sc-auth | `.agents/skills/sc-auth.md` |
| Cryptography | sc-crypto | `.agents/skills/sc-crypto.md` |
| Infrastructure | sc-infra | `.agents/skills/sc-infra.md` |
| Secrets Detection | sc-secrets | `.agents/skills/sc-secrets.md` |
| Configuration | sc-config | `.agents/skills/sc-config.md` |
| Input Validation | sc-input-validation | `.agents/skills/sc-input-validation.md` |
| Access Control | sc-access-control | `.agents/skills/sc-access-control.md` |
| Data Protection | sc-data-protection | `.agents/skills/sc-data-protection.md` |
...
1. **sc-verifier** (`.agents/skills/sc-verifier.md`)
...
1. **sc-report** (`.agents/skills/sc-report.md`)
...
1. **sc-diff-report** (`.agents/skills/sc-diff-report.md`)
...
- `sc-orchestrator` - Master coordination and state management (`.agents/skills/sc-orchestrator.md`)
- `sc-recon` - Codebase reconnaissance and architecture mapping (`.agents/skills/sc-recon.md`)
- `sc-dependency-audit` - Supply chain and dependency analysis (`.agents/skills/sc-dependency-audit.md`)
- `sc-verifier` - False positive elimination and confidence scoring (`.agents/skills/sc-verifier.md`)
- `sc-report` - Final comprehensive report generation (`.agents/skills/sc-report.md`)
- `sc-diff-report` - Incremental/PR diff security report (`.agents/skills/sc-diff-report.md`)

### Language-Specific Vulnerability Skills
- `sc-lang-js` - JavaScript/TypeScript (`.agents/skills/sc-lang-js.md`)
- `sc-lang-python` - Python (`.agents/skills/sc-lang-python.md`)
- `sc-lang-go` - Go (`.agents/skills/sc-lang-go.md`)
- `sc-lang-rust` - Rust (`.agents/skills/sc-lang-rust.md`)
- `sc-lang-java` - Java/Kotlin (`.agents/skills/sc-lang-java.md`)
- `sc-lang-c` - C/C++ (`.agents/skills/sc-lang-c.md`)
- `sc-lang-php` - PHP (`.agents/skills/sc-lang-php.md`)
- `sc-lang-ruby` - Ruby (`.agents/skills/sc-lang-ruby.md`)
- `sc-lang-csharp` - C#/.NET (`.agents/skills/sc-lang-csharp.md`)
- `sc-lang-swift` - Swift (`.agents/skills/sc-lang-swift.md`)

### Category Vulnerability Skills
- `sc-web` - Web application security (`.agents/skills/sc-web.md`)
- `sc-api` - API security (`.agents/skills/sc-api.md`)
- `sc-auth` - Authentication and session management (`.agents/skills/sc-auth.md`)
- `sc-crypto` - Cryptographic implementation review (`.agents/skills/sc-crypto.md`)
- `sc-infra` - Infrastructure and deployment security (`.agents/skills/sc-infra.md`)
- `sc-secrets` - Hardcoded secrets, API keys, credentials (`.agents/skills/sc-secrets.md`)
- `sc-config` - Security configuration review (`.agents/skills/sc-config.md`)
- `sc-input-validation` - Input validation and injection (`.agents/skills/sc-input-validation.md`)
- `sc-access-control` - Authorization and privilege escalation (`.agents/skills/sc-access-control.md`)
- `sc-data-protection` - PII handling and data leakage (`.agents/skills/sc-data-protection.md`)
